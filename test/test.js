...
describe( 'distributions-laplace-cdf', function tests() {
	...
	it( 'should compute the Laplace cdf when provided a number', function test() {
	...
	it( 'should evaluate the Laplace cdf when provided a plain array', function test() {
	...
	it( 'should evaluate the Laplace cdf when provided a typed array', function test() {
	...
	it( 'should evaluate the Laplace cdf element-wise and return an array of a specific type', function test() {
	...
	it( 'should evaluate the Laplace cdf element-wise using an accessor', function test() {
	...
	it( 'should evaluate the Laplace cdf element-wise and deep set', function test() {
	...
	it( 'should evaluate the Laplace cdf element-wise when provided a matrix', function test() {
	...
	it( 'should evaluate the Laplace cdf element-wise and return a matrix of a specific type', function test() {
		var validationData = require( './fixtures/matrix.json' ),
			mat,
			out,
			d1,
